...
export class StageFifteenSettings extends BaseStageSettings {
  constructor() {
    super();
    ...
    this.sceneNumber = 15;
    this.nextScene = new StageEnumMap().MapToString.get(StageEnum.stageSixteen);
    ...
    this.heartAppearProbabilitySeed = 4;
