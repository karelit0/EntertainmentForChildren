...
export class StageElevenSettings extends BaseStageSettings {
  constructor() {
    super();
    ...
    this.sceneNumber = 11;
    this.nextScene = new StageEnumMap().MapToString.get(StageEnum.stageTwelve);
