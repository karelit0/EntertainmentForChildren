...
export class StageThirteenSettings extends BaseStageSettings {
  constructor() {
    super();
    ...
    this.layerBackgroundNumer = 6;
    this.backgroundLayersSpeed = [0.05, 0.1, 0.15, 0.15, 0.2, 0.2];
